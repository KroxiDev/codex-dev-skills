...
Este skill se invoca cuando el usuario quiere crear una solicitud de refactor. Recorrer los pasos de abajo. Se pueden saltar pasos que no consideres necesarios.
...
7. Dividir la implementación en un plan de commits diminutos. Recordar el consejo de Martin Fowler: "haz cada paso de refactorización lo más pequeño posible, para que siempre puedas ver el programa funcionando".
