...
Lee por completo `${CLAUDE_PLUGIN_ROOT}/.agents/skills/wizard/SKILL.md` y sigue sus instrucciones.

Resuelve desde `${CLAUDE_PLUGIN_ROOT}/.agents/skills/wizard/` cualquier ruta relativa a `references/`, `scripts/` o `assets/`.
